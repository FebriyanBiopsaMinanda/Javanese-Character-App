...
# =========================
# POPUP HASIL PREDIKSI CANVAS
# =========================
@st.dialog("Hasil Prediksi Canvas", width="large")
def show_canvas_prediction_popup(canvas_rgba, predicted_class, aksara, confidence):
    col1, col2 = st.columns([1, 1], gap="large")

    with col1:
        preview_canvas = canvas_rgba[:, :, :3].astype("uint8")
        preview_image = Image.fromarray(preview_canvas)
    ...
    with col2:
        st.markdown(
            ...
            <div class='popup-result-box'>
                ...
                <p>Karakter (ꦏꦫꦏ꧀ꦠꦺꦂ) : <b style="font-size:42px;">{aksara}</b></p>
    ...
    with right_col:
        st.markdown(
            ...
            <div class='predict-card'>
                <h3>Canvas ꦲꦤꦕꦫꦏ</h3>
                <p>
                    Gambar satu karakter Aksara Jawa pada canvas. Klik tombol prediksi setelah menggambar aksara.
                </p>
                <p>
                    ꦒꦩ꧀ꦧꦂ ꦱꦠꦸ ꦏꦫꦏ꧀ꦠꦺꦂ ꦄꦏ꧀ꦱꦫ ꦗꦮ ꦥꦢ ꦕꦤ꧀ꦮ꦳ꦱ꧀꧉​ ꦏ꧀ꦭꦶꦏ꧀ ꦠꦺꦴꦩ꧀ꦧꦺꦴꦭ꧀ ꦥ꧀ꦫꦺꦢꦶꦏ꧀ꦱꦶ ꦱꦺꦠꦺꦭꦃ ꦩꦺꦤ꧀ꦒ꧀ꦒꦩ꧀ꦧꦂ ꦲꦏ꧀ꦱꦫ꧉​
                </p>
            </div>
            """,
            unsafe_allow_html=True,
        ...
        if not model_ready:
            ...
            st.info("""Canvas masih kosong. Silakan gambar Aksara Jawa terlebih dahulu.
                    \nꦕꦤ꧀ꦮ꦳ꦱ꧀ ꦩꦱꦶꦃ ꦏꦺꦴꦱꦺꦴꦤ꧀ꦒ꧀꧉​ ꦱꦶꦭꦏꦤ꧀ ꦒꦩ꧀ꦧꦂ ꦄꦏ꧀ꦱꦫ ꦗꦮ ꦠꦺꦂꦭꦺꦧꦶꦃ ꦢꦲꦸꦭꦸ꧉​""")

        else:
            st.success("""Canvas siap diprediksi. Klik tombol prediksi.
                       \nꦕꦤ꧀ꦮ꦳ꦱ꧀ ꦱꦶꦪꦥ꧀ ꦢꦶꦥ꧀ꦫꦺꦢꦶꦏ꧀ꦱꦶ꧉​ ꦏ꧀ꦭꦶꦏ꧀ ꦠꦺꦴꦩ꧀ꦧꦺꦴꦭ꧀ ꦥ꧀ꦫꦺꦢꦶꦏ꧀ꦱꦶ꧉​""")

        reset_col, _, predict_col = st.columns(3)

        predict_clicked = False

        with reset_col:
            if st.button("Reset (ꦫꦺꦱꦺꦠ꧀)", use_container_width=True):
                st.session_state.canvas_key += 1
                st.rerun()

        if model_ready and canvas_result.image_data is not None and not is_canvas_blank(canvas_result.image_data):
            with predict_col:
        ...
        if predict_clicked:
            if not model_ready:
                st.error("""Model belum siap digunakan.
                         \nꦩꦺꦴꦢꦺꦭ꧀ ꦧꦺꦭꦸꦩ꧀ ꦱꦶꦪꦥ꧀ ꦢꦶꦒꦸꦤꦏꦤ꧀꧉​""")

            else:
                image_input = preprocess_canvas_image(canvas_result.image_data)
                ...
                aksara = aksara_map.get(predicted_class.lower(), "-")

                show_canvas_prediction_popup(
